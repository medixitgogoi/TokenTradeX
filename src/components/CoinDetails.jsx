...
const Item = ({ title, value }) => (
  <HStack justifyContent={"space-between"} w={"full"} my={"4"}>
    <Text fontFamily={"Bebas Neue"} color={"#25274D"} letterSpacing={"widest"}>
      {title}
    </Text>
    <Text color={"#25274D"}>{value}</Text>
  </HStack>
);
...
const CustomBar = ({ high, low }) => (
  <VStack w={"full"}>
    ...
    <HStack justifyContent={"space-between"} w={"full"}>
      <Badge children={low} colorScheme={"#25274D"} />
      <Text fontSize={"sm"} color={"#25274D"}>24H Range</Text>
      <Badge children={high} colorScheme={"#25274D"} />
    </HStack>
  </VStack>
);
